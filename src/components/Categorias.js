        ...
        <div>
            <div className="min-h-[190px] bg-gray-100 flex justify-center items-center">
                <div className="grid grid-cols-5 gap-28 place-items-center overflow-x-auto whitespace-nowrap sm:gap-16 px-20 scrollbar-hide">
                    <div onClick={() => handleCategoryClick(1)} className="sm:h-44 sm:w-32 h-40 w-24 shadow-sm p-5 rounded-full bg-gray-300 flex flex-col justify-evenly items-center cursor-pointer hover:bg-primary duration-200">
                        <p className="text-center sm:text-lg text-base font-semibold">Mexicanos</p>
                        <img src={Burrito} alt="Mexicanos" className="w-auto" />
                    </div>
                    <div onClick={() => handleCategoryClick(2)} className="sm:h-44 sm:w-32 h-40 w-24 shadow-sm p-5 rounded-full bg-gray-300 flex flex-col justify-evenly items-center cursor-pointer hover:bg-primary duration-200">
                        <p className="text-center sm:text-lg text-base font-semibold">Mariscos</p>
                        <img src={Camaron} alt="Mariscos" className="w-auto" />
                    </div>
                    <div onClick={() => handleCategoryClick(3)} className="sm:h-44 sm:w-32 h-40 w-24 shadow-sm p-5 rounded-full bg-gray-300 flex flex-col justify-evenly items-center cursor-pointer hover:bg-primary duration-200">
                    ...
                    <div onClick={() => handleCategoryClick(4)} className="sm:h-44 sm:w-32 h-40 w-24 shadow-sm p-5 rounded-full bg-gray-300 flex flex-col justify-evenly items-center cursor-pointer hover:bg-primary duration-200">
                        <p className="text-center sm:text-lg text-base font-semibold">Bebidas</p>
                        <img src={Bebida} alt="Bebidas" className="sm:w-12 w-9" />
                    </div>
                    <div onClick={() => handleCategoryClick(5)} className="sm:h-44 sm:w-32 h-40 w-24 shadow-sm p-5 rounded-full bg-gray-300 flex flex-col justify-evenly items-center cursor-pointer hover:bg-primary duration-200">
